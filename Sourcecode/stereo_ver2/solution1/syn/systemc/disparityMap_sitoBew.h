...
// ==============================================================
#ifndef __disparityMap_sitoBew__HH__
#define __disparityMap_sitoBew__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_sitoBew) {
    ...
    SC_CTOR(disparityMap_sitoBew):  ACMP_sitofp_U ("ACMP_sitofp_U") {
