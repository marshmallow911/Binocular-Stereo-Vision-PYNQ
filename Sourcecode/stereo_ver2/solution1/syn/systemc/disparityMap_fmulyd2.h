...
// ==============================================================
#ifndef __disparityMap_fmulyd2__HH__
#define __disparityMap_fmulyd2__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_fmulyd2) {
    ...
    SC_CTOR(disparityMap_fmulyd2):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
