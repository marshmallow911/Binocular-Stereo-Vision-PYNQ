...
// ==============================================================
#ifndef __disparityMap_mul_Hfu__HH__
#define __disparityMap_mul_Hfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_mul_Hfu) {
    ...
    SC_CTOR(disparityMap_mul_Hfu):  ACMP_smul_us_U ("ACMP_smul_us_U") {
