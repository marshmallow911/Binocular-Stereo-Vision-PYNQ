...
// ==============================================================
#ifndef __disparityMap_uitoAem__HH__
#define __disparityMap_uitoAem__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_uitoAem) {
    ...
    SC_CTOR(disparityMap_uitoAem):  ACMP_uitofp_U ("ACMP_uitofp_U") {
