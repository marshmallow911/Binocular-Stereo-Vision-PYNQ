...
// ==============================================================
#ifndef __disparityMap_fdivzec__HH__
#define __disparityMap_fdivzec__HH__
#include "ACMP_fdiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_fdivzec) {
    ...
    SC_CTOR(disparityMap_fdivzec):  ACMP_fdiv_U ("ACMP_fdiv_U") {
        ACMP_fdiv_U.clk(clk);
