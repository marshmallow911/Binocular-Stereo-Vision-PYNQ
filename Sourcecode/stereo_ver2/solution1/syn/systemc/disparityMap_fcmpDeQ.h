...
// ==============================================================
#ifndef __disparityMap_fcmpDeQ__HH__
#define __disparityMap_fcmpDeQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_fcmpDeQ) {
    ...
    SC_CTOR(disparityMap_fcmpDeQ):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
