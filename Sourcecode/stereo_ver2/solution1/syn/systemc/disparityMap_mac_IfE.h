...
// ==============================================================
#ifndef __disparityMap_mac_IfE__HH__
#define __disparityMap_mac_IfE__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_mac_IfE) {
    ...
    SC_CTOR(disparityMap_mac_IfE):  simcore_mac_0_U ("simcore_mac_0_U") {
