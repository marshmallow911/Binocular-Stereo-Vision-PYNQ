...
entity Loop_Loop_Row_profYi_rom is 
    generic(
             DWIDTH     : integer := 10; 
             AWIDTH     : integer := 8; 
...
architecture rtl of Loop_Loop_Row_profYi_rom is 
...
entity Loop_Loop_Row_profYi is
    generic (
...
architecture arch of Loop_Loop_Row_profYi is
    component Loop_Loop_Row_profYi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Loop_Loop_Row_profYi_rom_U :  component Loop_Loop_Row_profYi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
