...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module Loop_2_proc_PAR_LeOg_rom (
...
initial begin
    $readmemh("./Loop_2_proc_PAR_LeOg_rom.dat", ram0);
    $readmemh("./Loop_2_proc_PAR_LeOg_rom.dat", ram1);
end
...
Loop_2_proc_PAR_LeOg_rom Loop_2_proc_PAR_LeOg_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
