...
// ==============================================================
#ifndef __disparityMap_mac_wdI__HH__
#define __disparityMap_mac_wdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_mac_wdI) {
    ...
    SC_CTOR(disparityMap_mac_wdI):  simcore_mac_0_U ("simcore_mac_0_U") {
