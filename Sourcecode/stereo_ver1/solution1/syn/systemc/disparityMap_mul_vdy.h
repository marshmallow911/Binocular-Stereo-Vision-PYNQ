...
// ==============================================================
#ifndef __disparityMap_mul_vdy__HH__
#define __disparityMap_mul_vdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_mul_vdy) {
    ...
    SC_CTOR(disparityMap_mul_vdy):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
