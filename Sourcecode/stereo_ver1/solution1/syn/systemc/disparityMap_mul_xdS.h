...
// ==============================================================
#ifndef __disparityMap_mul_xdS__HH__
#define __disparityMap_mul_xdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(disparityMap_mul_xdS) {
    ...
    SC_CTOR(disparityMap_mul_xdS):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
